...
if (isset($_POST['Edit'])){
    ...
    $sql2="UPDATE exam set examname='$examname',starttime='$starttime',endtime='$endtime' where id='$id'";
...
<div class="cat">
    <form id="form2" method="post" action="editexam.php">
        ...
        <!--input type="text" name="examid" value="<?php echo $row['examid']?>"> <br><br-->
        <p>Exam Name</p>
        <input type="text" name="examname" value="<?php echo $row['examname']?>"><br><br>
        <!--input type="text" name="starttime" value="<?php echo $row['starttime']?>"><br><br-->
       <label style="font-size:x">Start Time</label> <input type="datetime-local" step="1" name="starttime" value="<?php echo $row['starttime']?>"><br><br>
        <label>Close Time</label> <input type="datetime-local" step="1" name="endtime" value="<?php echo $row['endtime']?>"><br><br>
        <!--input type="text" name="endtime" value="<?php echo $row['endtime']?>"><br><br-->
