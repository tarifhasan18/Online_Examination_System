...
if(isset($_POST['addsubject']))
{
    ...
    $sql="INSERT into subject(class,subject) values('$class','$subject')";
...
while($row=mysqli_fetch_array($query2))
{
  ...
  <tr>
    ...
    <td>
      <form class="form2" action="addsubject.php" method="post" >
                  <input type="text" name="subjectid" hidden value="<?php echo $row['subjectid']; ?>">
                  <input type="text" name="class" hidden value='<?php echo $row['class']; ?>'>
                  <button id="button1" name="edit">Edit</button>
    </form>

    <form class="form3" action="addsubject.php" method="post"> 
  ...
  if (confirm("Press a button!")) {
    <?php
                  ...
                  if (isset($_POST['delete'])) { 
                      ...
                      $sql6="DELETE from subject where subjectid='$subjectid'";
